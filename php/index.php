...
<head>
    ...
    <title>Php Tutorial | Learn Php Programming</title>
...
<body>
    ...
    <div class="d-flex">
        ...
        <ul class="nav flex-column bg-dark " style="width: 15%;" id="sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Php Features</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Php Installation</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Php Program</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Php Variables</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Php Keywords</a>
            </li>
