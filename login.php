...
<body class='snippet-body'>
    <div class="wrapper">
        <div class="card" accessibilityRole=form>
            ...
            <form class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center input-field mb-4"> <span class="fas fa-lock p-2"></span> <input
                        type="password" placeholder="Password" required class="form-control" id="pwd"> <button
                        class="btn" onclick="showPassword()"> <span class="fas fa-eye-slash"></span> </button> </div>
                <div class="d-sm-flex align-items-sm-center justify-content-sm-between">
                </div>
                <div class="my-3"> <input type="button" id="btn_login" value="Login" class="btn btn-primary"> </div>
